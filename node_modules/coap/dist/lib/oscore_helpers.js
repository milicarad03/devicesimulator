...
exports.getOscoreOptionValue = getOscoreOptionValue;
exports.parseOscoreOption = parseOscoreOption;
exports.hasOscoreOption = hasOscoreOption;
 ...
 */
function getOscoreOptionValue(packet) {
 ...
 */
function parseOscoreOption(value) {
    if (value.length === 0) {
 ...
 */
function hasOscoreOption(packet) {
    return getOscoreOptionValue(packet) != null;
}
//# sourceMappingURL=oscore_helpers.js.map