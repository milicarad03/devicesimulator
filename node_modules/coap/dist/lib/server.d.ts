...
import { type CoapServerOptions, type requestListener, type CoapPacket, type MiddlewareParameters, type Parameters } from '../models/models';
...
declare class CoAPServer extends EventEmitter {
    ...
    _oscoreContextManager: SecurityContextManager | null;
    _oscoreOnly: boolean;
     ...
     */
    _handle(packet: CoapPacket, rsinfo: AddressInfo, oscoreProtected?: boolean, oscoreSenderId?: Buffer, oscoreIdContext?: Buffer): void;
