...
class CoAPServer extends events_1.EventEmitter {
    constructor(serverOptions, listener) {
        ...
        this._oscoreContextManager = null;
        this._oscoreOnly = false;
        this._options = {};
        ...
        this._parameters = (0, parameters_1.createParameters)(this._options.parameters);
        ...
        this._oscoreOnly = (_a = this._options.oscoreOnly) !== null && _a !== void 0 ? _a : false;
        if (this._options.oscoreContexts != null) {
            this._oscoreContextManager = this._options.oscoreContexts;
            this._middlewares.push(middlewares_1.oscoreDecryptRequest);
        }
        this._middlewares.push(middlewares_1.handleServerRequest);
        // Multicast settings
        this._multicastAddress = (_b = this._options.multicastAddress) !== null && _b !== void 0 ? _b : null;
        this._multicastInterface = (_c = this._options.multicastInterface) !== null && _c !== void 0 ? _c : null;
        ...
        this._block1Cache = new cache_1.default(this._parameters.exchangeLifetime * 1000, () => {
            return {};
        });
        this._block2Cache = new cache_1.default(this._parameters.exchangeLifetime * 1000, () => {
            return null;
        });
    ...
    _sendProxied(packet, proxyUri, callback) {
        ...
        const message = (0, coap_packet_1.generate)(removeProxyOptions(packet), this._parameters.maxMessageSize);
        if (this._sock instanceof dgram_1.Socket) {
    ...
    _sendReverseProxied(packet, rsinfo, callback) {
        ...
        const message = (0, coap_packet_1.generate)(packet, this._parameters.maxMessageSize);
        if (this._sock instanceof dgram_1.Socket) {
            this._sock.send(message, port, host, callback);
        }
    }
     ...
     */
    _handle(packet, rsinfo, oscoreProtected = false, oscoreSenderId, oscoreIdContext) {
        ...
        const generateResponse = () => {
            const response = new Message(packet, (response, packet) => {
                var _a;
                let buf;
                const sender = new retry_send_1.default(sock, rsinfo.port, rsinfo.address, undefined, this._parameters);
                try {
                    buf = (0, coap_packet_1.generate)(packet, this._parameters.maxMessageSize);
                }
                catch (err) {
                ...
                if (oscoreProtected && this._oscoreContextManager != null && oscoreSenderId != null) {
                    const tokenHex = (_a = packet.token) === null || _a === void 0 ? void 0 : _a.toString('hex');
                    ...
                    if (oscore != null) {
                        oscore.encode(buf)
                            .then((encoded) => {
                            this._finishSendResponse(encoded, response, sender, request, packet, lru, Message);
                            // Token cleanup
                        ...
                        if (Message === observe_write_stream_1.default) {
                            response.once('close', () => {
                                var _a;
                                if (tokenHex != null) {
                                    (_a = this._oscoreContextManager) === null || _a === void 0 ? void 0 : _a.unbindToken(tokenHex, oscoreSenderId);
                                }
                            });
                        }
                        return;
                ...
                this._finishSendResponse(buf, response, sender, request, packet, lru, Message);
            });
    ...
    _finishSendResponse(buf, response, sender, request, packet, lru, Message) {
        ...
        if (this._options.sendAcksForNonConfirmablePackets === true ||
            ...
            sender.send(buf, avoidBackoff);
        }
        else {
            debug('OMIT ACK PACKAGE');
        }
    }
    addOscoreContext(instance, recipientId, idContext) {
        if (this._oscoreContextManager == null) {
            this._oscoreContextManager = new oscore_1.SecurityContextManager();
            // Insert OSCORE middleware before handleServerRequest if not already present
            const hsrIndex = this._middlewares.indexOf(middlewares_1.handleServerRequest);
            if (hsrIndex >= 0) {
                this._middlewares.splice(hsrIndex, 0, middlewares_1.oscoreDecryptRequest);
            }
            else {
                this._middlewares.push(middlewares_1.oscoreDecryptRequest);
            }
    ...
    removeOscoreContext(recipientId, idContext) {
        var _a;
        (_a = this._oscoreContextManager) === null || _a === void 0 ? void 0 : _a.removeContext(recipientId, idContext);
    }
